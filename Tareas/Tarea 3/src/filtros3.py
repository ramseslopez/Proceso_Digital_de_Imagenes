...
class filtros():
    ...
    def letras(self, img):
        """
        Convierte la imagen a un ascii acorde a su valor en gris

        Params
        img - imagen

        Returns
        imagen en formato de html
        """
    ...
    def letras_color(self, img):
        """
        Convierte la imagen a un ascii con una letra respetando los colores
    ...
    def letras_gris(self, img):
        """
        Convierte la imagen a un ascii con una letra en escala de grises
    ...
    def letras_color_v2(self, img):
        """
        Convierte la imagen a un ascii respetando sus colores acorde a su valor en gris
    ...
    def letras_gris_v2(self, img):
        """
        Convierte la imagen a un ascii en escla de grises acorde a su valor en gris
    ...
    def letras_color_text(self, img, text):
        """
        Convierte la imagen a un ascii de un texto respetando los colores
    ...
    def cartas(self, img):
        """
        Convierte la imagen a una en formato de cartas
    ...
    def dominos(self, img):
        """
        Convierte la imagen a una en formato de domino
    ...
    def dominos_black(self, img):
        """
        Convierte la imagen a una en formato de domino negro
